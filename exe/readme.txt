...
1. To test at roger(cluster at NCSA cyber group),  one needs to copy orbit_info.bin, roger_large_input.txt and roger_small_input.txt under ../inputFileDebug to this directory. 
