                                  ...
                                  int32 inputFileID)
{
    ...
    /* Data Unpack */
    {
        ...
        if(radi_sc_index < 0)
        {
            fprintf( stderr,radi_scales,datasetName);
            SDendaccess(sds_id);
            free(input_dataBuffer);
            return EXIT_FAILURE;
        }
        ...
        if(radi_off_index < 0)
        {
            fprintf( stderr,radi_offset,datasetName);
            SDendaccess(sds_id);
            free(input_dataBuffer);
            return EXIT_FAILURE;
        }
        ...
        int32 inputFileID)
{
    ...
    /* Data Unpack */
    {
        ...
        if(sc_index < 0)
        {
            fprintf( stderr,scaling_factor,datasetName);
            free(input_dataBuffer);
            SDendaccess(sds_id);
            return EXIT_FAILURE;
        }
        ...
        if(uncert_index < 0)
        {
            fprintf( stderr,specified_uncert,datasetName);
            free(input_dataBuffer);
            SDendaccess(sds_id);
            return EXIT_FAILURE;
        }
